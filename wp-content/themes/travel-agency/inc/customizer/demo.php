...
function travel_agency_customizer_demo_content( $wp_customize ) {
	...
	$theme_demo_content_desc .= '<span class="sticky_info_row download-link"><label class="row-element">' . __( 'Download Demo Content Zip File', 'travel-agency' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wp-content/uploads/2017/11/travel-agency-demo-content.zip' ) . '" target="_blank" rel="no-follow">' . __( 'Click here', 'travel-agency' ) . '</a></span><br />';
