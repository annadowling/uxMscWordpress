...
foreach( $travel_agency_sections as $s ){
...
function travel_agency_customize_preview_js() {
    ...
    wp_enqueue_script( 'travel_agency_customizer', get_template_directory_uri() . '/inc/js/customizer.js', array( 'customize-preview', 'customize-selective-refresh' ), '20151215', true );
}
...
function travel_agency_customizer_scripts() {
    ...
    wp_enqueue_script( 'travel-agency-customize', get_template_directory_uri() . '/inc/js/customize.js', array( 'jquery' ), '20170404', true );
}
